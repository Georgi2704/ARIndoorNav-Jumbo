...
class SignUpController: UIViewController {
    ...
    let logoImageView: UIImageView = {
        ...
        logo.image = #imageLiteral(resourceName: "jumbo-logo")
        return logo
    }()
    ...
    lazy var usernameContainerView: UIView = {
        ...
        //Located in Extensions.swift
        return view.textContainerView(view: view, image!, usernameTextField, tintColor: AppThemeColorConstants.gold, addMiniText: false, miniText: nil, miniTextTintColor: nil)
    }()
    lazy var passwordContainerView: UIView = {
        var view = UIView()
        let image = UIImage(systemName: "lock.fill")
        //Located in Extensions.swift
        return view.textContainerView(view: view, image!, passwordTextField, tintColor: AppThemeColorConstants.gold, addMiniText: true, miniText: TextConstants.passwordRequirements, miniTextTintColor: AppThemeColorConstants.gray)
    }()
    ...
    lazy var usernameTextField: UITextField = {
        var tf = UITextField()
        //Located in Extensions.swift
        tf = tf.textField(withPlaceholder: "Username", isSecureTextEntry: false, tintColor: AppThemeColorConstants.gold)
        tf.delegate = self
        return tf
    }()
    ...
    let dontHaveAccountButton: UIButton = {
        let button = UIButton(type: .system)
        button.translatesAutoresizingMaskIntoConstraints = false
        let attributedTitle = NSMutableAttributedString(string:"Already have an account?  ", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: AppThemeColorConstants.gold])
        attributedTitle.append(NSAttributedString(string: "Sign In", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: AppThemeColorConstants.gold]))
